...
interface EnvConfig {
  ...
  PASSWORD_HASH_SALT_ROUND: string;
...
const loadRequireEnvVariables = (): EnvConfig => {
  ...
  return {
    ...
    JWT_REFRESH_TOKEN_SECRET_EXPIRE: process.env
      .JWT_REFRESH_TOKEN_SECRET_EXPIRE as string,
    PASSWORD_HASH_SALT_ROUND: process.env.PASSWORD_HASH_SALT_ROUND as string,
